...
public interface GitlabClient {
    ...
    List<Milestone> getMilestones(@RequestHeader("Authorization") String authorization,
            @PathVariable("projectid") Integer projectid, @SpringQueryMap MilestonesQueryParams milestonesQueryParams);
    ...
    List<Issue> getIssuesForMilestone(@RequestHeader("Authorization") String authorization,
            @PathVariable("projectid") Integer projectid, @PathVariable("milestoneNumber") Integer milestoneNumber);
}